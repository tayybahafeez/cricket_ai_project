...
from cricket_ai.pipelines.preprocess import preprocess_for_training
...
def train(data_path: str) -> Dict:
    ...
    # Expecting a binary target column named 'won' (0/1)
    ...
    # One-hot encode (if any categoricals exist)
    ...
    # Save best model + meta (feature columns)
...
if __name__ == "__main__":
    path = str(DATA_DIR / "cricket_dataset.csv")
    print(train(path))
